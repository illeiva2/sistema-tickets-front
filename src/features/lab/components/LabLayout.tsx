...
const PESTANAS = [
  ...
  // Consulta para comercio: una fila por muestra con ficha y análisis, columnas a gusto de cada usuario.
  { to: "/modulos/laboratorio/analisis", label: "Análisis", end: false },
